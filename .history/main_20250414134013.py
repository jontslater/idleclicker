...
# Set up screen FIRST before loading and converting image
screen = pygame.display.set_mode([500, 360])
pygame.display.set_caption('Idle Restaurant')

# Now it's safe to load and convert the image
...
background_img = pygame.transform.scale(background_img, (500, 360))
...
def draw_station(station, y):
    ...
    pygame.draw.rect(screen, station["color"], [70, y - 15, 200, 30])
