...
def draw_station(station, y):
    ...
    # Draw circular icon
    # Draw station icon and circular border
    icon_scaled = pygame.transform.scale(Icon_img, (40, 40))
    icon_center = (30, y)  # Center of the 40x40 icon
    screen.blit(icon_scaled, (10, y - 20))
    pygame.draw.circle(screen, black, icon_center, 20, 2)  # Circular border
